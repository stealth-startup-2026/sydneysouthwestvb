        ...
        <div className="mx-auto grid max-w-3xl gap-6 sm:grid-cols-2">
          {LOCATIONS.map((loc) => (
            <div key={loc.name} className="rounded-xl bg-white p-8 shadow-sm ring-1 ring-dark/5">
              <div className="mb-4 flex h-12 w-12 items-center justify-center rounded-full bg-green text-xl"><span aria-hidden="true">📍</span></div>
              ...
              <div className="mt-4 flex h-36 items-center justify-center rounded-lg bg-dark/10 text-sm text-muted">Map placeholder</div>
